...
const Quote: FC = () => {
  return (
    <div className="flex flex-col items-center justify-center py-12 my-8 bg-gradient-to-r from-[#0c1f2f] via- via-[#193855] via-[#8799A7] via-[#003D60] to-[#0c1f2f] text-white px-4 md:px-8">{/**/}
