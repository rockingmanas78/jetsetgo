...
const PrivacyPolicy = () => {
  return (
    ...
    <div className="max-w-4xl mx-auto p-5">
        ...
        <p className="mt-4">We use Your Personal data to provide and improve the Service. By using the Service, You agree to the collection and use of information in accordance with this Privacy Policy. This Privacy Policy has been created with the help of the <a href="https://www.termsfeed.com/privacy-policy-generator/" target="_blank" className="text-blue-500 hover:text-blue-700">Privacy Policy Generator</a>.</p>
        ...
        <ul style={{ marginLeft: '20px' }}>
            ...
            <li><p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Jet Set Go LLC, L4- 23, Cross Road no 20, Sidhgora, Jamshedpur.</p></li>
            ...
            <li><p><strong>Country</strong> refers to: Jharkhand, India</p></li>
            ...
            <li><p><strong>Website</strong> refers to Jet Set Go Cabs, accessible from <a href="http://jetsetgocabs.com" rel="external nofollow noopener" target="_blank" style={{ color: '#0c1f2f' }}>jetsetgocabs.com</a></p></li>
...
<h3 className="text-xl font-semibold mt-6 mb-4">Types of Data Collected</h3>
<h4>Personal Data</h4>
...
<h3 className="text-xl font-semibold mt-6 mb-4">Delete Your Personal Data</h3>
...
<ul className="list-disc pl-8 mt-4 mb-4">
<li>
<p>By email: support@jetsetgocabs.com</p>
</li>
<li>
<p>By visiting this page on our website: <a href="jetsetgocabs.com" rel="external nofollow noopener" target="_blank">jetsetgocabs.com</a></p>
</li>
</ul>
    </div>
    </>
